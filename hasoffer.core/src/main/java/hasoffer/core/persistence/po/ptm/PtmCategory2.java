...
public class PtmCategory2 implements Identifiable<Long> {
    ...
    private static final IdWorker idWorker = IdWorker.getInstance(PtmCategory2.class);
    ...
    public PtmCategory2(long parentId, String name,
                       String imageUrl) {
    ...
    public boolean equals(Object o) {
        ...
        PtmCategory2 that = (PtmCategory2) o;
