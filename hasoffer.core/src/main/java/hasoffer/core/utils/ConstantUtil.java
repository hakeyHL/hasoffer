...
public class ConstantUtil {
    ...
    static {
        ...
        API_PTMSTDSKU_PARAM_MEAN_MAP.put("MAIN CAMERA Aperture", "	Aperture indicates the lens opening for letting in the light; lower aperture number means larger opening and thus better images.");
