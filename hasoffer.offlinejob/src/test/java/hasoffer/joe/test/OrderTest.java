...
public class OrderTest {
    ...
    @Resource
    private ISnapdealAffiliateService affiliateService;

    @org.junit.Test
    public void orderTest() {
        try {
            List<OrderStatsAnalysisPO> orderStatsAnalysisPOs = affiliateService.countOrderList(DateUtils.parseDate("2016-11-07", "yyyy-MM-dd"), DateUtils.parseDate("2016-11-09", "yyyy-MM-dd"));
