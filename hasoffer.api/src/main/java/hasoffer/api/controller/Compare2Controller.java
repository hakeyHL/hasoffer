...
public class Compare2Controller {
    ...
    public ModelAndView getcmpskus(HttpServletRequest request,
                                   @RequestParam(defaultValue = ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime) final String q,
                                   @RequestParam(defaultValue = ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime) final String brand,
                                   @RequestParam(defaultValue = ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime) final String sourceId,
                                   @RequestParam(defaultValue = ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime) String site,
    ...
    public String cmpSkus(@RequestParam(defaultValue = ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime) final String q,
                          @RequestParam(defaultValue = ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime) final String brand,
                          @RequestParam(defaultValue = ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime) final String sourceId,
                          @RequestParam(defaultValue = ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime) String site,
                          @RequestParam(defaultValue = "0") String price,
    ...
    public String newnewconfig(@RequestParam String url,
        ...
        String json = ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime;
...
//                SearchIO sio = new SearchIO(sourceId, q, brand, site, price, deviceInfo.getMarketChannel(), deviceId, page, pageSize);
                SearchIO sio = new SearchIO(sourceSid, ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, website.name(), "0", null, ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, page, pageSize);
                getSioBySearch(sio);
...
//        }
        ...
        if ((id).length() >= 10) {
            id = ApiUtils.removeBillion(Long.valueOf(id)) + ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime;
            ptmStdSku = ptmStdSKuService.getStdSkuById(Long.valueOf(id));
        }
        if (ptmStdSku != null) {
            sio = new SearchIO(ptmStdSku.getSourceId(), ptmStdSku.getTitle(), ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, ptmStdSku.getRefPrice() + ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, deviceInfo.getMarketChannel(), deviceId, page, pageSize);
            cr = getCmpPrices(sio, ptmStdSku, userToken);
        } else {
            product = productService.getProduct(Long.valueOf(id));
            if (product != null) {
                sio = new SearchIO(product.getSourceId(), product.getTitle(), ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, StringUtils.isEmpty(product.getSourceSite()) == true ? null : product.getSourceSite(), product.getPrice() + ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, deviceInfo.getMarketChannel(), deviceId, page, pageSize);
...
/*        UrmUser urmUser = appService.getUserByUserToken(userToken);
        if (urmUser != null) {
            jsonObject.getJSONObject(ConstantUtil.API_NAME_DATA).putAll(apiUtils.setEvaluateBrandFeaturesCompetitorsSummaryMap(ptmStdSku, new String[]{deviceInfo.getMarketChannel().name(), deviceId, urmUser.getId() + ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime}));
        } else {
    ...
    public ModelAndView getStdSkuCmpParams(@RequestParam(defaultValue = "0") long pId) {
        ...
        if (ptmStdSkuModel == null) {
            ...
            resultMap.put("Brand", ptmStdSkuModel.getBrand() == null ? ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime : ptmStdSkuModel.getBrand());
            resultMap.put("Model", ptmStdSkuModel.getModel() == null ? ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime : ptmStdSkuModel.getModel());
            resultMap.put("Price", ptmStdSkuModel.getMinPrice() + ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime);
            ...
            resultMap.put("Screen Resolution", ptmStdSkuModel.getScreen_Resolution() == null ? ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime : ptmStdSkuModel.getScreen_Resolution());
            resultMap.put("Operating System", ptmStdSkuModel.getOperating_System() == null ? ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime : ptmStdSkuModel.getOperating_System());
            resultMap.put("Network Support", ptmStdSkuModel.getNetwork_Support() == null ? ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime : ptmStdSkuModel.getNetwork_Support());
    ...
    private CmpResult getDefaultCmpResult(SearchIO sio, PtmCmpSkuIndex2 cmpSkuIndex) {
        ...
        return new CmpResult(0,
                new ProductVo(0L, sio.getCliQ(), ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, sio.getCliPrice(), currentDeeplink),
    ...
    private CmpResult getCmpResult(SearchIO sio, PtmCmpSkuIndex2 cmpSkuIndex) {
        ...
        if (ArrayUtils.hasObjs(cmpSkus)) {
            ...
            if (ArrayUtils.isNullOrEmpty(comparedSkuVos)) {
                ...
                throw new NonMatchedProductException(ERROR_CODE.UNKNOWN, ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, sio.getCliQ(), sio.getCliPrice());
            }
...
//            Set<Website> websiteSet = new HashSet<Website>();
            ...
            if (ArrayUtils.hasObjs(cmpSkus)) {
                ...
                if (ArrayUtils.isNullOrEmpty(comparedSkuVos)) {
                    throw new NonMatchedProductException(ERROR_CODE.UNKNOWN, ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, product.getTitle(), product.getPrice());
                }
                //根据价格排序
...
//                }
            ...
            String specs = ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime;
    ...
    public void getSioBySearch(SearchIO sio) {
        ...
        if (srmSearchLog != null
            ...
            if (srmSearchLog.getPtmProductId() <= 0) {
                throw new NonMatchedProductException(ERROR_CODE.UNKNOWN, sio.getCliQ(), ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, 0);
            }
    ...
    public void searchForResult(SearchIO sio) throws NonMatchedProductException {
        ...
        if (ArrayUtils.isNullOrEmpty(skuModels)) {
            throw new NonMatchedProductException(ERROR_CODE.UNKNOWN, _q, ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, 0);
        }
        ...
        if (comparedSkuMap.size() < 1) {
            throw new NonMatchedProductException(ERROR_CODE.UNKNOWN, _q, ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, maxMc);
        } else {
    ...
    private CmpResult getCmpPrices(SearchIO sio, PtmStdSku ptmStdSku, String userToken) {
        ...
        if (pagedCmpskus != null && pagedCmpskus.getData() != null && pagedCmpskus.getData().size() > 0) {
            ...
            if (ArrayUtils.hasObjs(cmpPriceList)) {
                ...
                if (ArrayUtils.isNullOrEmpty(comparedSkuVos)) {
                    throw new NonMatchedProductException(ERROR_CODE.UNKNOWN, ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime, ptmStdSku.getTitle(), ptmStdSku.getRefPrice());
                }
                //根据价格排序
                ApiUtils.getSortedProListVoListByClicCountAsc(comparedSkuVos);
