...
public class Compare2Controller {
    ...
    public static void main(String[] args) {
        String dealUrlWithAff = WebsiteHelper.getDeeplinkWithAff(Website.SHOPCLUES, "www.flipkart.com/mens-clothing/jeans/~40-80-per-off/pr?sid=2oq%2Cs9b%2C94h", new String[]{MarketChannel.GOOGLEPLAY.name(), "dfecc858243a616a"});
