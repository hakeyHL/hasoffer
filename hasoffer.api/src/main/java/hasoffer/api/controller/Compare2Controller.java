...
//            Set<Website> websiteSet = new HashSet<Website>();
            ...
            if (ArrayUtils.hasObjs(cmpSkus)) {
                ...
                for (PtmCmpSku cmpSku : cmpSkus) {
                    ...
                    cplv.setDeepLinkUrl(WebsiteHelper.getDealUrlWithAff(cmpSku.getWebsite(), cmpSku.getUrl(), new String[]{sio.getMarketChannel().name(), sio.getDeviceId()}));
        ...
        if (pagedCmpskus != null && pagedCmpskus.getData() != null && pagedCmpskus.getData().size() > 0) {
            ...
            if (ArrayUtils.hasObjs(cmpSkus)) {
                ...
                for (PtmCmpSku cmpSku : cmpSkus) {
                    ...
                    cplv.setDeepLink(WebsiteHelper.getDealUrlWithAff(cmpSku.getWebsite(), cmpSku.getUrl(), new String[]{sio.getMarketChannel().name(), sio.getDeviceId()}));
                    comparedSkuVos.add(cplv);
                }
                if (ArrayUtils.isNullOrEmpty(comparedSkuVos)) {
