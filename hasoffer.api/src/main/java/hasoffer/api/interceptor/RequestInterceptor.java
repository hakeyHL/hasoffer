...
public class RequestInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o) throws Exception {
        ...
        String userToken = Context.currentContext().getHeader("usertoken", ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime);
            ...
            modelAndView.addObject("result", new ResultVo(ConstantUtil.API_ERRORCODE_SUCCESS, ConstantUtil.API_NAME_MSG_SUCCESS));
                ...
                for (String id : ids) {
                    ...
                    if (!flag) {
                        ...
                        urmUserDevice.setUserId(urmUser.getId() + ConstantUtil.API_DATA_EMPTYSTRINGstr_createTime);
